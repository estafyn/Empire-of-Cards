...
- **NPC Friendships**:
  - Meet characters representing different aspects of cassowary society.
  - These NPCs provide emotional anchors amidst the city's harsh, corporate atmosphere.
...
- A WTA enforcer informs you of a significant debt with only one week to repay.
- **Tension Established**: Failure leads to total enslavement in the corporate mining operations.

### 5\. Optional Attempts to Repay

- Players may attempt quick jobs or side gigs (e.g., cockatoo message delivery, insect farm work), but full repayment is nearly impossible.

### 6\. Inevitable Debt Default

- The final day arrives, and the WTA seizes your remaining shares—fully owning you.
...
- Cutscenes/dialogues explain your enslavement and assignment to a penal colony gold mine by the Werribee Traders Association.
...
- **NPC Interactions**:
  ...
  - WTA overseers: A mix of strict, sadistic, or sympathetic guards.
  - **Memories of Werribee**: Flashbacks highlight lost freedom and connections.
...
- The train arrives at a desolate mining town: bleak, heavily guarded, WTA banners, and endless dust.
...
- **Camp Layout**:
  ...
  - Mining pits/claims.
  - WTA offices and guards' barracks.
...
### 1\. NPCs & Social Structures

- Extensive NPC dialogue reveals cassowary cultural norms, like polycule family structures.
- Interactions highlight the social dynamics of this advanced ancient civilization.
